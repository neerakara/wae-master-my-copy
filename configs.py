...
# MOG config
config_mog = {}
config_mog['dataset'] = 'mog'
config_mog['verbose'] = True
config_mog['save_every_epoch'] = 20
config_mog['print_every'] = 50
config_mog['work_dir'] = 'results_mog'
#config_mog['plot_num_pics'] = 400
#config_mog['plot_num_cols'] = 20
config_mog['input_normalize_sym'] = False
config_mog['data_dir'] = 'mog'

config_mog['optimizer'] = 'adam' # adam, sgd
config_mog['adam_beta1'] = 0.5
config_mog['lr'] = 0.001
config_mog['lr_adv'] = 0.0005
config_mog['lr_schedule'] = 'manual' #manual, plateau, or a number
config_mog['batch_size'] = 100
config_mog['epoch_num'] = 100
config_mog['init_std'] = 0.0099999
config_mog['init_bias'] = 0.0
config_mog['batch_norm'] = True
config_mog['batch_norm_eps'] = 1e-05
config_mog['batch_norm_decay'] = 0.9
#config_mog['conv_filters_dim'] = 4

config_mog['e_pretrain'] = True
config_mog['e_pretrain_sample_size'] = 1000
config_mog['e_noise'] = 'add_noise'
config_mog['e_num_filters'] = 1024
config_mog['e_num_layers'] = 4
config_mog['e_arch'] = 'mlp' # mlp, dcgan, ali

config_mog['g_num_filters'] = 1024
config_mog['g_num_layers'] = 3
config_mog['g_arch'] = 'mlp' # mlp, dcgan, dcgan_mod, ali

config_mog['gan_p_trick'] = False
config_mog['d_num_filters'] = 512
config_mog['d_num_layers'] = 4

config_mog['zdim'] = 8
config_mog['pz'] = 'normal' # uniform, normal, sphere
config_mog['cost'] = 'l2sq' #l2, l2sq, l1
config_mog['pz_scale'] = 1.
config_mog['z_test'] = 'mmd'
config_mog['mmd_kernel'] = 'IMQ' # RBF, IMQ
config_mog['lambda'] = 10.
config_mog['lambda_schedule'] = 'constant'

config_mog['toy_dataset_dim'] = 2
config_mog['toy_dataset_size'] = 1000
config_mog['gmm_max_val'] = 5.0
config_mog['gmm_modes_num'] = 3
config_mog['random_seed'] = 400
